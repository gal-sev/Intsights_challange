...
export const baseDataExample: pasteI[] = [
	{
	  ...
	  contentShort: 'http://cpsexxklpu7kgwu4h4noa6ewlwinszoo6gw463elubo4y2lc3u6nfnyd.onion/\n' +
	...
	},
	{
	  ...
	  contentShort: 'Darknet Trusted Links\n' +
		' \n' +
	...
	},
	{
	  ...
	  contentFull: 'DeepMagic Shop, sells best hashish pollen, buprenorphine (subutex), cocaine,more a section dedicated to all what is knowed about deepweb.I have been in the deep since 2011 (silk road 1) I decided to open my own site that I built myself, I am very honest I sell in different markets, but I am satisfied if users migrate to my site, I sell by email I have two emails one for clearweb and one for deepweb but I expect my users to use pgp when they contact me by email, just take a look at what I have done with my very little knowledge of html and css I have not used programs to make the site but only the knowledge that I remember even if I am very inexperienced I am satisfied with what I have built the URL is:\n' +
		...
		'NEW CLEAN URL ARE :\n' +
		' \n' +
		'http://deepmagkklbsofjmrsgmeth5wzxtrof6dxfz2xevz2retkhy36kdnoad.onion/\n' +
		' \n' +
		'http://zvyppvbkqs7yzbkqeh4qxm4os6qfwehaahjc7m7wzqfbkmzum7vedxyd.onion/\n' +
		' \n' +
		'New hash brown-yellow very soft (Demeter) hight grade level hash recommended to those who like soft hash that whips up when you heat it.\n' +
		'New hash blonde very soft  pollen (mickey mouse) just now listed in the site this hash is the best avaible in moroc at the moment!!!\n' +
		'New hash high level quality blonde pollen (Lexus Hash)just now listed in the site!!! \n' +
		'New hash high level quality pollen THC +++ CBD +++ (Louis Vuitton Hash) just now listed in the site!!!\n' +
		' \n' +
		' \n' +
		' \n' +
		'thanks to all of you and best regards \n' +
		' \n' +
		'You can find me also in AlphaBay market, in DarkFox market and in Royal market.',
	  date: 'Fri Sep 09 2022'
	},
	{
	  author: 'Anonymous',
	...
	},
	{
	  ...
	  contentFull: '.\n' +
		...
		'Snow Bin - http://snowbin45znsonv227ypgbuvpqyaoolxpdg3nhhfznahe3exif6z7tyd.onion.\n' +
		' \n' +
		'NEW! - Surveys on snow bin \n' +
		'http://snowbin45znsonv227ypgbuvpqyaoolxpdg3nhhfznahe3exif6z7tyd.onion/poll/entry.php\n' +
		'.\n' +
		'Snow Bin is a new pastebin that shows the lastest 50 pastes.\n' +
		'Anyone can make a paste anonumously and it wont block pastes based on duplicate previous pastes.\n' +
		'It means if you want to paste something regularly on the site, you can without the paste being rejected!.\n' +
		'.\n' +
		' - Post your website.\n' +
		' - Post your Services .\n' +
		' - Post Information on anything you want.\n' +
		' - Explore Others posts\n' +
		' - Discover new links and information.\n' +
		' \n' +
		'.\n' +
		'ID  bfF1Dea',
	  date: 'Fri Sep 09 2022'
	...
	{
	  author: 'Anonymous',
	  title: 'MITNICK LENS HACKERS',
	  contentShort: 'MITNICKLENSHACKERS provide various forms of hacking services and provide result in real-time. \n' +
	...
	},
	{
	  ...
	  contentFull: 'A new chatroom has been opned on the dark web.\n' +
		...
		'           \n' +
		' - No Censorship                                                             \n' +
		' - Anything you say is overwritten after it reaches the top\n' +
